...
export const createResident = async (input: CreateResidentInput): Promise<IResident> => {
...
export const deleteResidentById = async (residentId: string): Promise<IResident | null> => {
